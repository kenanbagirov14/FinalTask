...
namespace FinalProject.Persistence.Migrations
{
    ...
    [Migration("20231112071324_path2")]
    partial class path2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Group", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 410, DateTimeKind.Local).AddTicks(724));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 409, DateTimeKind.Local).AddTicks(4997));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Setting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 409, DateTimeKind.Local).AddTicks(8130));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 411, DateTimeKind.Local).AddTicks(9691));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 412, DateTimeKind.Local).AddTicks(2829));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 410, DateTimeKind.Local).AddTicks(7785));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 411, DateTimeKind.Local).AddTicks(2760));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 13, 24, 411, DateTimeKind.Local).AddTicks(7163));
