...
namespace FinalProject.Persistence.Migrations
{
    ...
    [Migration("20231117070546_first")]
    partial class first
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Group", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 607, DateTimeKind.Local).AddTicks(8901));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 607, DateTimeKind.Local).AddTicks(4309));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Setting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 607, DateTimeKind.Local).AddTicks(6968));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 609, DateTimeKind.Local).AddTicks(671));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 609, DateTimeKind.Local).AddTicks(4087));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 608, DateTimeKind.Local).AddTicks(2079));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 608, DateTimeKind.Local).AddTicks(5381));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 17, 11, 5, 46, 608, DateTimeKind.Local).AddTicks(8477));
