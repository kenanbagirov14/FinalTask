...
namespace FinalProject.Persistence.Migrations
{
    ...
    [Migration("20231111052444_ffffe")]
    partial class ffffe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Group", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 54, DateTimeKind.Local).AddTicks(170));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 52, DateTimeKind.Local).AddTicks(7767));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Setting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 53, DateTimeKind.Local).AddTicks(8496));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 57, DateTimeKind.Local).AddTicks(4584));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 57, DateTimeKind.Local).AddTicks(6797));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 56, DateTimeKind.Local).AddTicks(8148));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 57, DateTimeKind.Local).AddTicks(493));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 9, 24, 44, 57, DateTimeKind.Local).AddTicks(2884));
