...
namespace FinalProject.Persistence.Migrations
{
    ...
    [Migration("20231111080849_ffffee")]
    partial class ffffee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Group", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 251, DateTimeKind.Local).AddTicks(2891));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 250, DateTimeKind.Local).AddTicks(640));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Setting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 251, DateTimeKind.Local).AddTicks(1246));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 254, DateTimeKind.Local).AddTicks(6380));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 254, DateTimeKind.Local).AddTicks(8576));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 253, DateTimeKind.Local).AddTicks(9804));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 254, DateTimeKind.Local).AddTicks(2246));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 11, 12, 8, 49, 254, DateTimeKind.Local).AddTicks(4610));
