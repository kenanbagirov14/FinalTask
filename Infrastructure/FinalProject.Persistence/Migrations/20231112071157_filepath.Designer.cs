...
namespace FinalProject.Persistence.Migrations
{
    ...
    [Migration("20231112071157_filepath")]
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Group", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 6, DateTimeKind.Local).AddTicks(4673));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Message", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 5, DateTimeKind.Local).AddTicks(7022));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Setting", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 6, DateTimeKind.Local).AddTicks(1708));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Student", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 8, DateTimeKind.Local).AddTicks(6945));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.General.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 9, DateTimeKind.Local).AddTicks(756));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 6, DateTimeKind.Local).AddTicks(9556));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 7, DateTimeKind.Local).AddTicks(6774));
            ...
            modelBuilder.Entity("FinalProject.Domain.Entities.Identity.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 12, 11, 11, 57, 8, DateTimeKind.Local).AddTicks(3866));
